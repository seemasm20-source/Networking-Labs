...
|---|-------|-------|-----|------|
| 1 | PCs could not communicate across LANs | Wrong default gateway on PCs | Set correct gateway on all PCs | [view](./troubleshooting/wrong-gateway-issue.md) |
| 2 | Router interface administratively down | no shutdown typed at wrong CLI level | Entered interface mode first then no shutdown | [view](./troubleshooting/interface-down-issue.md) |
